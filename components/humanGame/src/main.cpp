...
/** \mainpage RoboComp::humanGame
 *
 * \section intro_sec Introduction
 *
 * The humanGame component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/humanGame --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class humanGame : public RoboComp::Application
{
public:
	humanGame (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::humanGame::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
