...
RoboCompAprilTagsServer::AprilTagsServer::_iceD_getAprilTags(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    ::RoboCompAprilTagsServer::tagsList ret = this->getAprilTags(::std::move(iceP_frame), iceP_tagsize, iceP_mfx, iceP_mfy, current);
...
void
RoboCompAprilTagsServer::AprilTagsServerPrx::_iceI_getAprilTags(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompAprilTagsServer::tagsList>>& outAsync, const ::RoboCompAprilTagsServer::Image& iceP_frame, double iceP_tagsize, double iceP_mfx, double iceP_mfy, const ::Ice::Context& context)
{
...
RoboCompAprilTagsServer::AprilTagsServer::_iceD_getAprilTags(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_mfy);
    inS.endReadParams();
    ::RoboCompAprilTagsServer::tagsList ret = this->getAprilTags(iceP_frame, iceP_tagsize, iceP_mfx, iceP_mfy, current);
