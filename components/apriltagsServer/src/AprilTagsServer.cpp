...
RoboCompAprilTagsServer::AprilTagsServer::_iceD_getAprilTags(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::RoboCompAprilTagsServer::Image iceP_frame;
    istr->readAll(iceP_frame);
    inS.endReadParams();
    ::RoboCompAprilTagsServer::tagsList ret = this->getAprilTags(::std::move(iceP_frame), current);
...
void
RoboCompAprilTagsServer::AprilTagsServerPrx::_iceI_getAprilTags(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompAprilTagsServer::tagsList>>& outAsync, const ::RoboCompAprilTagsServer::Image& iceP_frame, const ::Ice::Context& context)
{
...
::IceProxy::Ice::Object* ::IceProxy::RoboCompAprilTagsServer::upCast(::IceProxy::RoboCompAprilTagsServer::AprilTagsServer* p) { return p; }

void
::IceProxy::RoboCompAprilTagsServer::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompAprilTagsServer::AprilTagsServer>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
    ...
    {
        v = new ::IceProxy::RoboCompAprilTagsServer::AprilTagsServer;
        v->_copyFrom(proxy);
    }
}

::Ice::AsyncResultPtr
IceProxy::RoboCompAprilTagsServer::AprilTagsServer::_iceI_begin_getAprilTags(const ::RoboCompAprilTagsServer::Image& iceP_frame, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
::Ice::Object* RoboCompAprilTagsServer::upCast(::RoboCompAprilTagsServer::AprilTagsServer* p) { return p; }
...
RoboCompAprilTagsServer::AprilTagsServer::_iceD_getAprilTags(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    ::RoboCompAprilTagsServer::tagsList ret = this->getAprilTags(iceP_frame, current);
...
RoboCompAprilTagsServer::AprilTagsServer::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    Ice::StreamWriter< ::RoboCompAprilTagsServer::AprilTagsServer, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    Ice::StreamReader< ::RoboCompAprilTagsServer::AprilTagsServer, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
...
{
    handle = ::RoboCompAprilTagsServer::AprilTagsServerPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(::RoboCompAprilTagsServer::AprilTagsServer::ice_staticId(), v);
    }
}
