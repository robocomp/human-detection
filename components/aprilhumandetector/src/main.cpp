...
/** \mainpage RoboComp::aprilhumandetector
 *
 * \section intro_sec Introduction
 *
 * The aprilhumandetector component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/aprilhumandetector --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class aprilhumandetector : public RoboComp::Application
{
public:
	aprilhumandetector (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::aprilhumandetector::initialize()
{
...
int ::aprilhumandetector::run(int argc, char* argv[])
{
	...
	tprx = std::make_tuple(apriltagsserver_proxy,humanpose_pubproxy);
