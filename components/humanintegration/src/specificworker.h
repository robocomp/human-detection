...
private:
	...
	void writeToJSON_gnn(const ModelPeople &people, const RoboCompHumanCameraBody::GroundTruth &gt);
	void writeToJSON_new(const ModelPeople &people, const RoboCompHumanCameraBody::GroundTruth &gt);
