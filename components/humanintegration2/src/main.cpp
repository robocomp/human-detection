...
/** \mainpage RoboComp::humanIntegration2
 *
 * \section intro_sec Introduction
 *
 * The humanIntegration2 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/humanIntegration2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class humanIntegration2 : public RoboComp::Application
{
public:
	humanIntegration2 (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::humanIntegration2::initialize()
{
...
int ::humanIntegration2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		{
			std::cout << "ERROR Unsubscribing topic: humancamerabody " << ex.what()<<std::endl;
		}
...
int main(int argc, char* argv[])
{
	...
	::humanIntegration2 app(prefix, startup_check_flag);
