...
/** \mainpage RoboComp::humanPose
 *
 * \section intro_sec Introduction
 *
 * The humanPose component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/humanPose --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class humanPose : public RoboComp::Application
{
public:
	humanPose (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::humanPose::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
