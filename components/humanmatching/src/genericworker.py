...
#Initialization State machine
		...
		self.check_new_data_state.addTransition(self.check_new_datatocheck_new_data, self.check_new_data_state)
		...
		self.results_update_state.addTransition(self.results_updatetocheck_new_data, self.check_new_data_state)
